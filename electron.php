...
#$x_shift = 1500;
$x_shift = 1500;
$tr_shift = 1500;#смещение для проекции (y,z)
...
function bigpixel($x,$y,$color) {
	...
	imagefilledellipse($im,$scale*$x,cv($y),$scale*$diam,$scale*$diam,$color);
...
#echo "<br>i=$i; \$x=$x,\$y=$y,\$z=$z,1,\$blue,0,\$xe=$xe";
		...
		#електрон
		bigpixel($xe+$x_shift,0,$red);	
		
		#energy volume point
		bigpixel($x+$x_shift,$y,$color);
